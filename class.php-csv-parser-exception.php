<?php
	 ...
	 * getFilename() - Returns the name of the file where the exception was thrown (should always be class.php-csv-parser.php)
	 ...
	 * @link
	 */
	class PhpCSV_Parser_Exception extends Exception {
		 ...
		 */
		public function __construct($message,$filename,$linenum,$description) {
		...
		/**
		 * Returns the full error messgae taking into consideration the context of the error
		 * @return string
		 */
		public function getFullMessage(){
			$error_message = sprintf(
				"Error with message '%s (Description: %s)' in file '%s' on line %d",
				parent::getMessage(), $this->getDescription(), $this->getFilename(), $this->getLineNumber()
			);
		 ...
		 * @return \PhpCSV\PhpCSV_Parser_Exception
		 */
